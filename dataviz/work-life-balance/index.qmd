...
Majority of the days are centered around the barycenter (⬤) of the triangle, meaning that most days were mostly balanced. The cloud of point near the top right indicate days when I had little [<b>study</b>]{style="color:darkred;"} and mostly relaxed or socialized. Meanwhile, points to the LEFT are days when I [<b>studied</b>]{style="color:darkred;"} or socialized often at the expense of [<b>sleep</b>]{style="color:darkblue;"}
