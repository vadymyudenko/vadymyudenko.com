...
schedule was, add to that that I've not been getting enough [<b>sleep</b>]{style="color:#3B4CC0;"} on
...
ggplot(hist_wake_up, aes(x = percentage, y = time_column, fill = period)) +
  ...
  geom_richtext(
    ...
    aes(x = 4, 
        y = "11:20", 
        label = "Bedtime and mornings in <span style='color:navy'><strong>2020</strong></span> are normal(ish)."),
    label.color = NA,
    fill = NA,
    hjust = 0,
    vjust = 0.5,
    ...
    aes(x = 4, 
        y = "11:00", 
        label = "Stable sleep schedule has left the chat in <span style='color:#FFCC33'><strong>2023</strong></span>"),
    label.color = NA,
    fill = NA,
    hjust = 0,
    vjust = 0.5,
...
activity. Sounds like a typical student life. 
